...
const cards = [
  ...
  { titulo: "Tempo Médio de Fechamento", valor: "18 dias", descricao: "Últimos 30 dias" },
  { titulo: "Leads Atendidos", valor: 112, descricao: "Este mês" },
...
export default function PerformancePage() {
  return (
    <div className="w-full max-w-6xl mx-auto py-6">
      <h1 className="text-2xl md:text-3xl font-extrabold mb-8 text-white/90 tracking-tight">Performance</h1>
