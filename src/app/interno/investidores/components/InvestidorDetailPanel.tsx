...
import { X, User, Mail, Tag, MessageSquare, Calendar, StickyNote, FilePlus } from 'lucide-react';
        ...
        <SidePanel open={sidePanelOpen} onClose={() => setSidePanelOpen(false)} title="Nova Página">
          <div className="flex flex-col gap-4 w-full">
            ...
            <button
              ...
              onClick={() => setDocContent('Exemplo de conteúdo gerado por IA para este investidor. (Mock)')}
            >
              Gerar com IA
            </button>
            <button
