...
export default function HeroSection() {
  ...
  return (
    <section className="relative flex flex-col items-center justify-center min-h-[70vh] sm:py-12 py-4 text-center overflow-hidden bg-gradient-to-b from-[#0D1A3A] to-[#000000]">
