...
function Home() {
    return (<>
      <head_1.default>
        ...
        <meta name="description" content="CRM Imobiliário moderno, seguro e minimalista."/>
      </head_1.default>
      <main className="min-h-screen flex flex-col items-center justify-center bg-umde-dark px-4">
        <section className="w-full max-w-3xl bg-[#101C3A]/80 rounded-2xl shadow-2xl p-8 md:p-16 flex flex-col items-center gap-8 mt-12 mb-12 animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center w-full">
            <a href="/cadastro" className="inline-flex items-center justify-center px-8 py-4 rounded-full bg-umde-blue text-white font-bold text-lg shadow-lg hover:bg-blue-800 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-400 scale-100 hover:scale-105 active:scale-95" tabIndex={0}>
              Comece Grátis Agora
            </a>
            <a href="#demo" className="inline-flex items-center justify-center px-8 py-4 rounded-full border-2 border-umde-blue text-umde-blue font-bold text-lg bg-umde-dark hover:bg-blue-900 hover:text-white transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-200 scale-100 hover:scale-105 active:scale-95" tabIndex={0}>
